...
let geolink = "https://earthquake.usgs.gov/earthquakes/feed/v1.0/summary/all_week.geojson";
...
d3.json(geolink).then(function(data) {
    console.log(data);
...
// Grabbing our GeoJSON boundary data.
